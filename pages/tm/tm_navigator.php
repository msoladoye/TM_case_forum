                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul id="tmFunction" style="display: none; list-style: none;">
                                    <li><a href="index.php"><i class="side-nav"></i> TM CASE VIEW</a></li>
                                    <li><a href="ground_rules.php"><i class="side-nav"></i> GROUND RULES</a></li>
                                    <li><a href="add_new_case_tm.php"><i class="side-nav"></i> ADD NEW CASE</a></li>
                                    <li><a href="#"><i class="side-nav"></i> REPORT STOLEN CASE</a></li>
                                    <li><a href="tm_score_board.php"><i class="side-nav"></i> TM SCORE BOARD</a></li>
                                </ul>
                            </li>
                            <li>
